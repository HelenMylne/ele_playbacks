...
# 0.08613353
#        2.5%         50%       97.5%
# -0.11585623  0.01088694  0.25522477
# 0.3275
...
# 0.08943609
#        2.5%           50%         97.5%
# -0.2664078426 -0.0003964301  0.1485671663
# 0.5525
...
# 0.1112177
#        2.5%         50%       97.5%
# -0.36065043 -0.01782668  0.12209064
# 0.7425
...
# 0.1357503
#        2.5%          50%        97.5%
# 5.366156e-08 1.222890e-01 4.611858e-01
# 0.025
...
# 0.1733766
#        2.5%          50%        97.5%
# 0.0003204371 0.2235205400 0.5664840468
# 0.0125
...
# 0.1451698
#        2.5%         50%       97.5%
# -0.19342233  0.05569539  0.38925699
# 0.24
...
# 0.09876166
#        2.5%         50%       97.5%
# -0.13005230  0.01215365  0.29827420
# 0.333845
...
# 0.1276028
#        2.5%         50%       97.5%
# -0.22305343  0.00481212  0.36429913
# 0.3893851
...
# 0.1282573
#        2.5%           50%         97.5%
# -0.3115031982 -0.0003803229  0.2701802247
# 0.5380329
...
# 0.01544849
#        2.5%          50%        97.5%
# 3.164343e-05 1.219243e-02 5.282498e-02
# 0
...
# 0.08893449
#        2.5%          50%        97.5%
# 0.0004119641 0.1366458303 0.2652982496
# 0
...
# 0.1654802
#        2.5%         50%       97.5%
# 0.000899235 0.290896644 0.479610280
# 0
...
# 0.0287642
#        2.5%           50%         97.5%
# -4.751317e-02 -4.110765e-05  6.969258e-02
# 0.5154951
...
contrasts_long %>%
  ...
  geom_density(aes(x = difference, colour = contrast_stim, fill = contrast_stim),
               alpha = 0.4)+
  facet_grid(f_age_cat ~ contrast_sect, scales = 'free_y')+
  scale_colour_viridis_d()+
  scale_fill_viridis_d()+
...
contrasts_long %>%
  ...
  geom_density(aes(x = difference, colour = f_age_cat, fill = f_age_cat),
               alpha = 0.4)+
  facet_grid(contrast_stim ~ contrast_sect, scales = 'free_y')+
  scale_colour_viridis_d()+
  scale_fill_viridis_d()+
  labs(colour = 'effect of changing stimulus',
       fill = 'effect of changing stimulus')+
...
print('age1 vs age2')
mean(age1_vs_age2) ; sd(age1_vs_age2)
quantile(age1_vs_age2, prob = c(0.025, 0.5, 0.975))
length(which(age1_vs_age2 < 0)) / length(age1_vs_age2)
# "age1 vs age2"
# -0.05109239
# 0.06551212
#        2.5%           50%         97.5%
# -2.348441e-01 -2.736488e-02 -1.757489e-05
# 0.988

print('age2 vs age3')
mean(age2_vs_age3) ; sd(age2_vs_age3)
quantile(age2_vs_age3, prob = c(0.025, 0.5, 0.975))
length(which(age2_vs_age3 < 0)) / length(age2_vs_age3)
# "age2 vs age3"
# -0.0349966
# 0.03837458
#        2.5%           50%         97.5%
# -0.1364762175 -0.0212840360 -0.0000344134
# 0.988

print('age3 vs age4')
mean(age3_vs_age4) ; sd(age3_vs_age4)
quantile(age3_vs_age4, prob = c(0.025, 0.5, 0.975))
length(which(age3_vs_age4 < 0)) / length(age3_vs_age4)
# "age3 vs age4"
# -0.04231413
# 0.04770683
#        2.5%           50%         97.5%
# -1.749580e-01 -2.697882e-02 -2.504969e-05
# 0.988

print('age1 vs age4')
mean(age1_vs_age4) ; sd(age1_vs_age4)
quantile(age1_vs_age4, prob = c(0.025, 0.5, 0.975))
length(which(age1_vs_age4 < 0)) / length(age1_vs_age4)
# "age1 vs age4"
# -0.1503862
# 0.1383534
#        2.5%           50%         97.5%
# -0.4824948715 -0.1186472329 -0.0001378788
# 0.988
